        ...
        <div class="col-md-8">
            <div class="news-section">
                ...
                <div class="pagination-wrapper">
                    <?php echo e($articles->links('custom-pagination')); ?>
            ...
            <div class="sidebar">
                <div class="sidebar-widget">
                    ...
                    <div class="trending-list">
                        <?php $__currentLoopData = $articles->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trending): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="trending-item">
                                <div class="trending-number"><?php echo e($loop->iteration); ?></div>
                                <div class="trending-content">
                                    <a href="<?php echo e(route('article.show', $trending->id)); ?>" 
                                       class="trending-title">
                                        <?php echo e(Str::limit($trending->title, 60)); ?>

                                    </a>
                                    <span class="trending-date">
                                        <?php echo e($trending->created_at->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\backend-news-website\resources\views/home.blade.php ENDPATH**/ ?>